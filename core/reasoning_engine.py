...
Loops until the task is complete, intelligently handling failures.
"""
...
class ReasoningEngine:
    ...
    async def run_loop(self, context: str, plan: Optional[Plan] = None,
                       on_step=None) -> AsyncIterator[ReasoningState]:
        """
        ...
        logger.info("Reasoning loop completed after %d iterations", iteration + 1)
